...
#                 # print(records_to_insert[name])
#             # supabase.table('Resources').insert(records_to_insert[name]).execute()
#     else:
...
# print(records_to_insert)
# get resources in each county
# for county in counties:
#     print(county)
#     query1 = f"foster care mental health resources in {county}, TX"
#     query2 = f"foster care financial aid in {county}, TX"
#     find_resources(query1, county)
#     find_resources(query2, county)
# response = supabase.table('Resources').select('hours').execute()
# hours = list(row['hours'] for row in response.data)
# # print(hours)
# for hour in hours:
#     # print(hour)
