...
function HomeCarousel() {
  const images = [
    { src: "/images/FrontPageImage.jpg", alt: "Image 1", caption: "Image 1" },
    { src: "/images/homePage2.jpg", alt: "Image 2", caption: "Image 2" },
    { src: "/images/homePage3.jpg", alt: "Image 3", caption: "Image 3" },
  ];
